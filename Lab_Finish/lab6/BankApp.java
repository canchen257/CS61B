...
public class BankApp {
  ...
  *  @exception IOException if there are problems reading user input.
  */
  private void doDeposit() throws BadAccountException,IOException {
    // Get account number.
   ...
   *  @exception IOException if there are problems reading user input.
   */
  private void doWithdraw() throws BadAccountException,BadTransactionException,IOException {
    // Get account number.
    int acctNumber = readInt("Enter account number: ");
   ...
   *  @exception IOException if there are problems reading user input.
   */
  private void doInquire() throws BadAccountException,IOException {
    int acctNumber = readInt("Enter account number: ");
